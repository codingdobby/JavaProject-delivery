...
public class Delivery_Select extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delivery_Select window = new Delivery_Select(toss);
	 ...
	 */
	public Delivery_Select(String toss) {
		this.toss = toss;
		setTitle("자배 택배");
		...
		panelTitle.setLayout(new BorderLayout(0, 0));
				...
				panel_point_Btn.setBackground(SystemColor.control);
				panel_point_Btn.setBorder(new EmptyBorder(20, 20, 20, 20));
				panelTitle.add(panel_point_Btn, BorderLayout.EAST);
				panel_point_Btn.setLayout(new BorderLayout(0, 0));
				
				JButton btn_Point = new JButton("포인트 조회");
				btn_Point.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						Cus_Point CP = new  Cus_Point(toss);
						CP.setVisible(true);
					}
				});
				panel_point_Btn.add(btn_Point, BorderLayout.CENTER);
				
				JPanel panel_5 = new JPanel();
				panel_5.setBackground(SystemColor.control);
				panel_5.setBorder(new EmptyBorder(30, 10, 30, 0));
		...
		/*********************************************************************/
		// 배달 전 아이콘
		ImageIcon start_before = new ImageIcon(Delivery_Select.class.getResource("/image/start_before.png"));
		...
		ImageIcon start_ing = new ImageIcon(Delivery_Select.class.getResource("/image/start_ing.png"));
		...
		/*********************************************************************/
		// 기사 전달 전 아이콘
		ImageIcon delivery_before = new ImageIcon(Delivery_Select.class.getResource("/image/delivery_before.png"));
		...
		/*********************************************************************/
		// 기사 전달 중 아이콘
		ImageIcon delivery_ing = new ImageIcon(Delivery_Select.class.getResource("/image/delivery_ing.png"));
		...
		/*********************************************************************/
		// 배송 전 아이콘
		ImageIcon shipping_before = new ImageIcon(Delivery_Select.class.getResource("/image/shipping_before.png"));
		...
		/*********************************************************************/
		// 배송 중 아이콘
		ImageIcon shipping_ing = new ImageIcon(Delivery_Select.class.getResource("/image/shipping_ing.png"));
		...
		/*********************************************************************/
		// 배달완료 아이콘
		ImageIcon complete_before = new ImageIcon(Delivery_Select.class.getResource("/image/complete_before.png"));
		...
		/*********************************************************************/
		// 배달 중 아이콘
		ImageIcon complete_ing = new ImageIcon(Delivery_Select.class.getResource("/image/complete_ing.png"));
		...
		panel.add(lbArrow);
		lbArrow.setIcon(new ImageIcon(Delivery_Select.class.getResource("/image/right-arrow.png")));
		...
		lbArrow1.setIcon(new ImageIcon(Delivery_Select.class.getResource("/image/right-arrow.png")));
		...
		lbArrow2.setIcon(new ImageIcon(Delivery_Select.class.getResource("/image/right-arrow.png")));
